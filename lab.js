...
lastItemRemoved.push(arr.splice(5, 1));
console.log(arr);
...
/*
  Determine if the letter grade of the given variable 'score'. If the variable is a 90 or above, console-log an 'A',
  between 80 and 89, console-log a 'B', between 70 and 79, 'C', between 60 and 69, 'D', 
...
//log 'There are not enough elements in this array' to the console. If the length is more than 7,
//reassign the value of 'someNum' to the value of the 7th element in the array.
...
} else if (myFavoriteNumbers.length <= 6) {
  myFavoriteNumbers.push(someNum[6]);
}
...
/* The famous FizzBuzz, Devmountain style!
  ...
  if the number your for loop is currently on is divisible by 3, console.log 'Dev'. If the number is divisible by 5, 
  console.log 'mountain'. If the number is divisible by 5 & 3, console.log 'Devmountain'. 
